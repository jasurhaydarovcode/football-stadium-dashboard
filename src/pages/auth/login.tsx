...
function login() {
  ...
  const handleChange = (e) => {
    setPhoneValue(e.target.value); // Update the state with the new input value
  };
              ...
              <div className="p-4 md:p-5">
                <div className="space-y-4">
                  <div>
                    ...
                    <input ref={phone} value={phoneValue} onChange={handleChange} type="text" name="email" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="+998 90 123 45 67" required />
                  </div>
                  <div>
                  ...
                  <button onClick={Registerlogin} type="submit" className="transition duration-200 ease-in-out  w-full bg-gradient-to-b from-gray-700 to-black text-white font-semibold py-2 px-4 rounded-md hover:opacity-90">
